...
be read as ``\path{[\emph{location/to/which/repository/was/cloned}]/firmware/common/uart.c}''.
...
the ADC reading input to \textpm 4095.  Firmware or software can look for the negative full-scale
...
conversion, the input should be clamped to \textpm 4095.
