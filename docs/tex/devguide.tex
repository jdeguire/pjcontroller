...
issues certain version of PySerial seem to have with USB serial devices.
...
scripts into executable files.  PyInstaller claims to be able to generate executables under 32-bit
and 64-bit Windows XP and later, Mac OS X 10.4 and later, and various Linux distros, as well as
Solaris and AIX.  At the the time of this writing, PyInstaller has been tried on Windows 7 64-bit
without trouble.
...
application exits when the user click the close button on the window header.
