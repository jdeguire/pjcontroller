...
This section lists the changes that have been made to the different board revisions over time.
Board revisions will be formatted as ``A0'', where the letter indicates a major revision and the
number is a minor fix.

\begin{enumerate}[A.]
  \item Initial major revision.
    \begin{enumerate}[(1)]
        \setcounter{enumii}{-1}    % make next counter start at 0
      \item Initial minor revision
    \end{enumerate}
\end{enumerate}
...
\begin{center}
    \begin{tabular}{c|c|c|p{0.45\textwidth}}
...
The firmware use the ATMega328P's UART module for communicating to whatever PC it is connected to.
...
\subsubsection{Status Codes} \label{sssec:FWBootStatusCodes}
